...
let
  ...
  package = stdenvNoCC.mkDerivation rec {
    ...
    src = fetchzip {
      ...
      stripRoot = false;
      hash = "sha256-qtPuJgXVgrksQFdl13g50fzNfAYhTtBltLyHMiwBHU4=";
    };
    ...
    buildCommand = ''
      ...
      ${jdk21}/bin/java -Dswing.defaultlaf=com.sun.java.swing.plaf.motif.MotifLookAndFeel -jar $out/opt/STM32CubeMX/STM32CubeMX "\$@"
      EOF
